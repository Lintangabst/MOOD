  ...
  return (
    <div className="min-h-screen bg-white">
      <main className="container mx-auto px-4 md:px-8 py-10 max-w-7xl">
        {/* Greeting */}
        <h2 className="text-2xl font-bold mb-1 text-green-500">Hallo, {firstName}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Card Poin */}
          <div className="bg-green-500 rounded-xl flex items-center justify-between text-white">
            <div className="w-1/2">
            ...
            <div className="flex-1 text-center">
              ...
              <p
                ...
                onClick={() => setShowTukarPoin(!showTukarPoin)}
              >
          ...
          {/* Info Card */}
          <div className="bg-blue-400 rounded-xl py-6 px-12 text-white flex flex-col justify-center">
            ...
            <button className="bg-white text-black border-2 border-green-500 flex flex-col justify-center font-medium px-4 py-2 rounded hover:bg-green-500 w-fit">
              Kerjakan Latihan!
            </button>
          </div>
        </div>
        ...
        {showTukarPoin ? <TukarPoin /> : <StatusTukarPoin />}
      </main>
    </div>
  );
};
